...
class RepositoriesMobilePage extends StatelessWidget {
            ...
            InkWell(
              ...
              child: Obx(
                () => Card(
                  elevation: 3,
                  shadowColor:
                      controller.getAppTodoHover ? Colors.green : Colors.blue,
                  child: Container(
                    padding: EdgeInsets.all(8),
                    height: 130,
                    width: Get.width * 0.7,
            ...
            InkWell(
              ...
              child: Obx(
                () => Card(
                  elevation: 3,
                  shadowColor:
                      controller.getBlogHover ? Colors.green : Colors.blue,
                  child: Container(
                    height: 120,
                    width: Get.width * 0.7,
                    decoration: BoxDecoration(
